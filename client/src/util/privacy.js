...
export async function decryption(
  ...
  // const encryptionKeyForDecryption = await getEcryptionKeyForDecryption(
  //   `${refConversation}/keys`,
  //   getGun,
  //   currentAlias
  // );
...
async function decryptedKeyPromiseFun(
  senderEpub,
  myPair,
  getGun,
  refMail,
